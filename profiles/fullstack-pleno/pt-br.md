...
# RESUMO PROFISSIONAL
Desenvolvedor Full Stack Pleno com mais de 5 anos de experiência, especializado no ecossistema Node.js (TypeScript) e interfaces modernas em React.js. Domínio completo do ciclo de desenvolvimento de software, desde a criação de interfaces responsivas de alto desempenho (Astro, Next.js) até o desenho de APIs escaláveis sob arquiteturas de Microsserviços e DDD. Forte experiência em integrações complexas de APIs de terceiros (HubSpot, Zendesk), mensageria com RabbitMQ e bancos de dados (PostgreSQL, MongoDB). Formado em Administração, uno a proficiência técnica (testes com Jest e containers Docker) a uma sólida visão de negócios voltada para a otimização de fluxos de conversão e ROI.

# HABILIDADES TÉCNICAS
* Frontend: React.js, Next.js, Astro, JavaScript (ES6+), Tailwind CSS, UX/UI, SEO Avançado.
* Backend: Node.js, TypeScript, Express, Fastify, APIs RESTful.
* Arquitetura e Mensageria: Microsserviços, Arquitetura Hexagonal, Domain-Driven Design (DDD), RabbitMQ.
* Persistência de Dados e ORMs: PostgreSQL, MongoDB, MySQL, Prisma, TypeORM, Strapi (Headless CMS).
* Qualidade e Infraestrutura: Testes Automatizados (Jest), Testes Unitários e de Integração, Docker, Docker Compose.
* Processo de Produto: Escrita de User Stories, Levantamento de Requisitos, Metodologias Ágeis (Scrum, Kanban).
